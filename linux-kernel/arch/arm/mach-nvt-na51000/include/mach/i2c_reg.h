...
/*
	...
	msgs.len = 2;
	buf[0] = NVT_I2C_SET_XX;
	buf[1] = cfg value;
	msgs.buf = buf;

	i2c_nvtim_xfer(struct i2c_adapter *adap, struct i2c_msg msgs[], 1);

*/
// i2c_msg.flags
#define NVT_I2C_SET_CFG_FLG			0x100		/* set config flag */
// i2c_msg.buf[0]
#define NVT_I2C_SET_RST 1	// buf[1] : valid: 0~1 (0: do nothing, 1: reset i2c module when bus free timeout), default 0.


#define NVT_I2C_MAX_NR 5	// max controller num
