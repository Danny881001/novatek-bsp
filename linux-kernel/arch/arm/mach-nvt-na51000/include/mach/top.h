...
typedef enum {
	...
	PIN_SENSOR_CFG_SPCLK_3RD = 0x8000000, ///< Enable SP_CLK on L_GPIO[26]
...
typedef enum {
	...
	PIN_SENSOR6_CFG_12BITS = 0x40,      ///< 12 bit sensor. Enable SN6_D[0..11]/SN6_PXCLK on P_GPIO[18..21][2..9]/P_GPIO[10]
...
typedef enum {
	...
	PIN_ETH_CFG_RGMII = 0x08,                        ///< Enable ETH RGMII on L_GPIO[12..16]/L_GPIO[17]/L_GPIO[19]/L_GPIO[22..26]/L_GPIO[27]/L_GPIO[28..29]
	...
	PIN_ETH_CFG_MII_NO_TXER    = 0x40,               ///< Enalbe ETH MII MII on L_GPIO[12..26]/L_GPIO[28..29]
...
/*
    PINMUX selection for DSP channel
...
*/
typedef enum {
	PINMUX_DSP_CH_INACTIVE,                        //< DSP channel inactive
	PINMUX_DSP_CH_ACTIVE,                          //< DSP channel  active
	ENUM_DUMMY4WORD(PINMUX_DSP_CH_SEL)
} PINMUX_DSP_CH_SEL;
