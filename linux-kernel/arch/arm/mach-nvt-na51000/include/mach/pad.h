...
extern ER pad_set_pull_updown(UINT32 pin, PAD_PULL pulltype);
extern ER pad_get_pull_updown(UINT32 pin, PAD_PULL *pulltype);
extern ER pad_set_drivingsink(UINT32 name, PAD_DRIVINGSINK driving);
extern ER pad_get_drivingsink(UINT32 name, PAD_DRIVINGSINK *driving);
